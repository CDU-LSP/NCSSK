...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot c_addsub_1 xil_defaultlib.c_addsub_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim c_addsub_1 -key {Behavioral:sim_1:Functional:c_addsub_1} -tclbatch cmd.tcl -log simulate.log
}
