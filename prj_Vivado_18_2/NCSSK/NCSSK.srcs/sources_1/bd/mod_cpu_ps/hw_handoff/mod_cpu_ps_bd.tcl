...
################################################################
# This is a generated script based on design: mod_cpu_ps
#
...
proc create_root_design { parentCell } {
  ...
  set sys_rst [ create_bd_port -dir O -from 0 -to 0 sys_rst ]
  ...
  # Create instance: axi_gpio_angle_valid, and set properties
  set axi_gpio_angle_valid [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_angle_valid ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS {1} \
  ...
  # Create instance: axi_gpio_sys_rst, and set properties
  set axi_gpio_sys_rst [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_sys_rst ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
   CONFIG.C_GPIO_WIDTH {1} \
 ] $axi_gpio_sys_rst
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_gpio_sys_rst/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net axi_gpio_sys_rst_n_gpio_io_o [get_bd_ports sys_rst] [get_bd_pins axi_gpio_sys_rst/gpio_io_o]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports sys_clk_PS_100M] [get_bd_pins axi_gpio_angle/s_axi_aclk] [get_bd_pins axi_gpio_angle_valid/s_axi_aclk] [get_bd_pins axi_gpio_data_in_ena/s_axi_aclk] [get_bd_pins axi_gpio_delay_point/s_axi_aclk] [get_bd_pins axi_gpio_sys_rst/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_gpio_angle/s_axi_aresetn] [get_bd_pins axi_gpio_angle_valid/s_axi_aresetn] [get_bd_pins axi_gpio_data_in_ena/s_axi_aresetn] [get_bd_pins axi_gpio_delay_point/s_axi_aresetn] [get_bd_pins axi_gpio_sys_rst/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_sys_rst/S_AXI/Reg] SEG_axi_gpio_sys_rst_n_Reg
