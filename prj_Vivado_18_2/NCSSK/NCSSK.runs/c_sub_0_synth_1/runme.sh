...
HD_PWD='E:/Users/benji/OneDrive/FPGA_Project/NCSSK/prj_Vivado_18_2/NCSSK/NCSSK.runs/c_sub_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_sub_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_sub_0.tcl
