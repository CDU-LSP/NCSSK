...
HD_PWD='E:/Users/benji/OneDrive/FPGA_Project/NCSSK_copy_v1.1.0/NCSSK.runs/ila_phase_diff_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_phase_diff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_phase_diff.tcl
