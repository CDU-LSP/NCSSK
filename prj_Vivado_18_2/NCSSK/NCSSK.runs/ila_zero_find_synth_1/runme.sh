...
HD_PWD='E:/Users/benji/OneDrive/FPGA_Project/copy/NCSSK/NCSSK.runs/ila_zero_find_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_zero_find.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_zero_find.tcl
