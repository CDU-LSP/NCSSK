...
#
# Generated by Vivado on Tue Dec 01 20:39:41 +0800 2020
...
# Script info
echo -e "c_addsub_0.sh - Script generated by export_simulation (Vivado v2018.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"E:/2018.2/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"E:/2018.2/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"E:/2018.2/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../NCSSK.srcs/sources_1/ip/c_addsub_0/c_addsub_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.c_addsub_0 xil_defaultlib.glbl -o c_addsub_0_simv
}
