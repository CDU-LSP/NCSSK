...
#
# Generated by Vivado on Wed Dec 02 22:28:14 +0800 2020
...
# Script info
echo -e "dist_mem_gen_0.sh - Script generated by export_simulation (Vivado v2018.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work dist_mem_gen_v8_0_12 $vlogan_opts +v2k +incdir+"D:/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/simulation/dist_mem_gen_v8_0.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"D:/Xilinx/Vivado/2018.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../NCSSK.srcs/sources_1/ip/dist_mem_gen_0/sim/dist_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
