...
#
# Generated by export_simulation on Sun Nov 08 00:35:48 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './c_sub_0.sh' script.

./c_sub_0.sh -reset_run
...
./c_sub_0.sh -noclean_files

For more information on the script, please type './c_sub_0.sh -help'.
